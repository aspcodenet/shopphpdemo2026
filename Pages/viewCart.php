...
if (count($cartItems) > 0) {
    // Get all products + get all cartitems
    // generate test prompt
    // läs rrsultat in i en array
    $apiKey = "ak-fc-b928cddd5bd781b9a271b8cdecc52b13a6bdfc713259490b34532c6b11fe39e1";
